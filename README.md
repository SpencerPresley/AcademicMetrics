...
[![GitHub Combined Issues](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/search/issues?q=repo:SpencerPresley/COSC425-DATA+repo:SpencerPresley/academic-metrics+type:issue&label=issues&query=$.total_count&color=green)](https://github.com/SpencerPresley/academic-metrics/issues) [![GitHub Combined Forks](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/search/repositories?q=repo:SpencerPresley/COSC425-DATA+repo:SpencerPresley/academic-metrics+fork:true&label=forks&query=$.total_count&color=blue)](https://github.com/SpencerPresley/academic-metrics/network/members) [![GitHub Combined Stars](https://img.shields.io/badge/dynamic/json?url=https://api.github.com/search/repositories?q=repo:SpencerPresley/COSC425-DATA+repo:SpencerPresley/academic-metrics&label=stars&query=$.total_count&color=yellow)](https://github.com/SpencerPresley/academic-metrics/stargazers) [![GitHub license](https://img.shields.io/github/license/SpencerPresley/academic-metrics)](https://github.com/SpencerPresley/academic-metrics/blob/main/LICENSE) [![GitHub star chart](https://img.shields.io/github/stars/SpencerPresley/academic-metrics?style=social)](https://star-history.com/#SpencerPresley/academic-metrics) [![Dependency Status](https://img.shields.io/librariesio/github/SpencerPresley/academic-metrics)](https://libraries.io/github/SpencerPresley/academic-metrics) [![Downloads](https://static.pepy.tech/badge/academic-metrics/month)](https://pepy.tech/project/academic-metrics)
